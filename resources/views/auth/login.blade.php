    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4" x-data="{ showPass: false }">
            ...
            <div class="relative mt-1">
                <input id="password" :type="showPass ? 'text' : 'password'" name="password" required autocomplete="current-password" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 pr-12">
