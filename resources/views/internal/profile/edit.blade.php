                        ...
                        <div class="ui-settings-panel ui-settings-panel-muted">
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Maksimal {{ $nameMax }} karakter.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Huruf, angka, atau garis bawah.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ui-settings-panel ui-settings-panel-amber">
                            ...
                            <div class="space-y-4">
                                ...
                                <div x-data="{ show: false }">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Minimal {{ $passwordMin }} karakter.</p>
                                </div>
