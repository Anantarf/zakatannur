<div class="ui-card overflow-hidden">
    ...
    <div class="p-4">
        <label class="flex cursor-pointer items-center gap-3 rounded-xl border border-slate-200 p-3 transition-colors hover:bg-slate-50" :class="is_transfer_global ? 'bg-brand-50 border-brand-200' : ''">
