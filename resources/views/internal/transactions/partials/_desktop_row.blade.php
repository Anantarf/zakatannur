<tr class="group transition-colors hover:bg-brand-50/30 stagger-item">
    ...
    <td class="whitespace-nowrap pl-2 pr-4 py-2 text-center sm:py-2.5">
        <div class="flex items-center justify-center gap-1.5">
            <a class="ui-btn ui-btn-secondary min-h-[32px] min-w-[32px] px-2 py-1.5 text-slate-500 hover:text-brand-600 hover:bg-brand-50" href="{{ route('internal.transactions.show', ['transaction' => $t->id]) }}" title="Lihat" aria-label="Lihat">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                </svg>
            </a>
            <a class="ui-btn ui-btn-secondary min-h-[32px] min-w-[32px] px-2 py-1.5 text-slate-500 hover:text-blue-600 hover:bg-blue-50" href="{{ route('internal.transactions.receipt', ['transaction' => $t->id]) }}" target="_blank" rel="noopener" title="Cetak" aria-label="Cetak">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                </svg>
            </a>
            <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                <button type="button" @click="open = !open" class="ui-btn ui-btn-secondary min-h-[32px] min-w-[32px] px-2 py-1.5 text-slate-500 hover:text-slate-800 focus:ring-brand-500" title="Opsi lainnya" aria-label="Opsi lainnya">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
