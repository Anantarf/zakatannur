                                    ...
                                    <tbody x-data="{ open: false }">
                                        <tr class="border-b border-slate-100 transition-colors hover:bg-slate-50">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <button type="button" @click="open = !open" class="mx-auto inline-flex min-h-[32px] min-w-[32px] items-center justify-center text-brand-600 transition-colors hover:text-brand-700" :aria-expanded="open" aria-label="Lihat detail log">
