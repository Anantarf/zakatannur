...
<body class="min-h-screen bg-[#eef4f1] text-slate-800 flex flex-col font-sans antialiased relative overflow-x-hidden pb-2 sm:pb-3"
    ...
    <div class="bg-emerald-50 py-12">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="mx-auto mt-4 max-w-2xl text-lg text-emerald-800">Gunakan asisten cerdas AI kami untuk berkonsultasi mengenai kewajiban zakat, nishab, dan cara perhitungannya.</p>
            <div class="mt-8 flex justify-center">
                <a href="{{ route('konsultasi') }}" class="rounded-md bg-emerald-800 px-6 py-3 text-base font-semibold text-white shadow-sm transition-all hover:bg-emerald-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-800">
