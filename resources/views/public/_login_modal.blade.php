                ...
                <div class="px-6 py-8 sm:p-10">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5" 
                        ...
                        <div x-data="{ showPass: false }">
                            ...
                            <div class="relative">
                                <input id="password" :type="showPass ? 'text' : 'password'" name="password" required class="block w-full rounded-xl border-gray-200 px-4 py-3 pr-12 text-gray-900 placeholder-gray-400 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 transition-all font-medium" placeholder="Kata sandi">
