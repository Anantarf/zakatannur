    ...
    <div class="ui-modal-box public-login-modal-box w-full max-w-md" x-show="openLogin" @click.away="openLogin = false" @keydown.escape.window="openLogin = false"
        ...
        <!-- Close Button -->
            <div class="absolute right-0 top-0 pr-3 pt-3 sm:pr-4 sm:pt-4">
                <button type="button" @click="openLogin = false" class="ui-modal-close-btn public-login-modal-close" aria-label="Tutup modal login">
        ...
        <div class="px-6 py-7 sm:p-8">
            <div class="text-center mb-6">
                <div class="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full border border-brand-100 bg-white p-1 shadow-sm overflow-hidden">
                    <img src="/images/logo_zakatannur.png" alt="Logo Zakat Annur" class="w-full h-full object-contain" />
                </div>
                <div class="mb-2">
                    <h2 id="public-login-title" class="text-xl font-bold tracking-[-0.02em] text-slate-900">Zakat Annur</h2>
                </div>
                <h3 class="text-base font-bold tracking-[-0.02em] text-slate-900">Masuk ke Sistem</h3>
