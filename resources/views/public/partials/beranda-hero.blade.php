<section class="relative group h-[240px] sm:h-[320px] overflow-hidden rounded-[1.6rem] sm:rounded-[1.8rem] shadow-2xl shadow-brand-950/10 ring-1 ring-black/5">
    ...
    <div class="absolute inset-x-0 bottom-0 z-20 p-5 sm:p-7">
        <div class="max-w-3xl">
            <p class="mb-2 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.3em] text-brand-100/90">
            ...
            <h2 class="text-[2rem] sm:text-[3rem] font-black text-white leading-[0.98] drop-shadow-2xl tracking-[-0.035em]">
                Amanah Dalam<br><span class="text-brand-400">Mengelola Kebaikan.</span>
            </h2>
            <p class="mt-3 max-w-xl text-[13px] sm:text-[15px] font-medium leading-relaxed text-brand-50/90">
