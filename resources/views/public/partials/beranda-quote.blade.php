<article class="public-quote-card">
    ...
    <div class="relative z-10 space-y-2.5 text-left">
        ...
        <div>
            <p class="text-[11px] font-semibold uppercase tracking-[0.14em] text-brand-700/85">&mdash; QS. At-Taubah: 103</p>
        </div>
    </div>
</article>
