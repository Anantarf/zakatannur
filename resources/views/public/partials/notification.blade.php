<div x-show="notification.show"
    ...
    <div class="bg-brand-600 text-white px-5 py-4 rounded-xl shadow-[0_15px_40px_rgba(16,185,129,0.3)] border border-brand-500/50 flex flex-col gap-1 backdrop-blur-sm bg-opacity-95">
