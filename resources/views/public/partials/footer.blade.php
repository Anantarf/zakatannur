<footer class="public-footer-shell">
    <div class="public-footer-credit">
        <span class="public-footer-kicker">Dikembangkan oleh</span>
        <div class="footer-item-group group flex flex-col items-center gap-1 sm:flex-row sm:gap-1.5">
            ...
            <img src="/images/logo_irk.webp" class="footer-logo h-3.5 w-auto opacity-60" alt="Logo IRK" loading="lazy" decoding="async">
        </div>
    </div>
</footer>
