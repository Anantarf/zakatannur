...
| KF-04 | Sistem menjaga konteks percakapan multi-turn, termasuk koreksi angka, lanjutan konsultasi, dan interupsi konsep. | `ChatbotConversationContextTest`, `ChatbotBehaviorDatasetTest`, `chatbot:eval-behavior` | 27 skenario/test | Lulus |
| KF-05 | Sistem melakukan kalkulasi deterministik untuk fitrah, fidyah, dan zakat mal dalam cakupan yang didukung. | `ChatbotCalculatorServiceTest`, `ChatbotSentinelParserTest`, tabel kalkulasi `CALC-01` sampai `CALC-07` | 17 kasus/test | Lulus |
