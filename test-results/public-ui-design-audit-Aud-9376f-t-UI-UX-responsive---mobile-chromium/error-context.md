...
main h2 "Zakat yang tercatat, amanah yang terlihat." overlaps a "Zakat Annur Masjid An-Nur Komplek BPK V Gandul Zakat Annur"
...
Error: strict mode violation: getByRole('button', { name: /Ringkasan/ }) resolved to 2 elements:
    1) <button @click="activeTab = 'laporan'" class="px-4 py-2.5 rounded-full text-xs font-bold transition-all duration-300 flex-1 text-white/80" :class="activeTab === 'laporan' ? (scrolled ? 'bg-brand-600 text-white shadow-md' : 'bg-white text-brand-900 shadow-lg') : (scrolled ? 'text-slate-600' : 'text-white/80')">↵                    Ringkasan↵                </button> aka getByRole('button', { name: 'Ringkasan', exact: true })
    ...
    - generic [ref=e3]:
      - generic [ref=e4]:
        ...
        - button "MASUK" [ref=e14] [cursor=pointer]:
          - img [ref=e15]
      - generic [ref=e17]:
        - button "Beranda" [ref=e18] [cursor=pointer]
        - button "Ringkasan" [ref=e19] [cursor=pointer]
        - button "Grafik" [ref=e20] [cursor=pointer]
  - main [ref=e21]:
    - generic [ref=e24]:
      - generic [ref=e25]:
        - img "Dokumentasi Masjid An-Nur" [ref=e29]
        - generic [ref=e31]:
          - heading "Zakat yang tercatat, amanah yang terlihat." [level=2] [ref=e32]
          - paragraph [ref=e33]: Informasi penerimaan zakat Masjid An-Nur disajikan terbuka untuk jamaah Komplek BPK V Gandul.
          - button "Lihat Ringkasan Penerimaan" [ref=e34] [cursor=pointer]
      - generic [ref=e35]:
        - generic [ref=e36]:
          - paragraph [ref=e37]: Tentang Portal
          - heading "Satu pintu informasi zakat untuk jamaah" [level=3] [ref=e38]
          - paragraph [ref=e39]: Portal ini membantu jamaah melihat informasi zakat Masjid An-Nur secara terbuka, ringkas, dan mudah dipantau.
        - generic [ref=e40]:
          - article [ref=e41]:
            - img [ref=e43]
            - generic [ref=e45]:
              - heading "Transparan" [level=4] [ref=e46]
              - paragraph [ref=e47]: Jamaah dapat membuka ringkasan penerimaan tanpa menunggu rekap manual.
          - article [ref=e48]:
            - img [ref=e50]
            - generic [ref=e52]:
              - heading "Mudah Dipantau" [level=4] [ref=e53]
              - paragraph [ref=e54]: Kategori zakat, total uang, beras, dan jiwa disusun dalam tampilan ringkas.
          - article [ref=e55]:
            - img [ref=e57]
            - generic [ref=e59]:
              - heading "Amanah" [level=4] [ref=e60]
              - paragraph [ref=e61]: Dikelola panitia zakat Masjid An-Nur untuk kebutuhan periode berjalan.
        - generic [ref=e62] [cursor=pointer]:
          - generic [ref=e63]:
            - img [ref=e65]
            - generic [ref=e67]:
              - paragraph [ref=e68]: Ringkasan Penerimaan
              - paragraph [ref=e69]: Lihat total dan kategori penerimaan zakat dalam ringkasan yang mudah dibaca.
          - img [ref=e71]
        - article [ref=e73]:
          - img [ref=e75]
          - generic [ref=e77]:
            - paragraph [ref=e78]: Pengingat
            - paragraph [ref=e79]: "\"Ambillah zakat dari harta mereka guna membersihkan dan mensucikan mereka, dan berdoalah untuk mereka...\""
            - paragraph [ref=e81]: "— QS. At-Taubah: 103"
  - contentinfo [ref=e82]:
    - generic [ref=e83]:
      - generic [ref=e84]: Powered by
      - generic [ref=e85]:
        - generic [ref=e86]: Ikatan Remaja Komplek BPK V Gandul
        - img "Logo IRK" [ref=e87]
  - button "Buka chatbot Zakky" [ref=e89] [cursor=pointer]:
    - img [ref=e93]
```
